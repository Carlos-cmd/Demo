...
public class LoginController implements CommunityConstant {
    ...
    public void getKaprcha(HttpServletResponse response/*, HttpSession session*/) {
        //生成验证码
...
//        session.setAttribute("kaptcha", text);
    ...
    public String login(String username, String password, String code,  @RequestParam(defaultValue = "false") Boolean remember,
                        Model model, /*HttpSession session,*/ HttpServletResponse response,@CookieValue(value = "kaptchaOwner",defaultValue = "null")String kaptchaOwner) {
